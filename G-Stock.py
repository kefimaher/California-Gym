...
def dashbroad_visibility():
 ...
 r1.place(x=100, y=800)
 r2.place(x=100, y=800)
...
def on_submit():
    ...
    if ((entered_text!="chercher un produit")and(entered_text!="")):
       ...
       produitarecherche.place(x=290, y=178)
       r1.place(x=5, y=170)
       r2.place(x=(600), y=170)
       search_zone.delete(0, "end")
...
items = tk.Button(r, text='Liste des produit', width=46, background="#683FA9", fg="white", highlightbackground="#683FA9", activebackground="#4E2A88", activeforeground="white", command=item_visibility)
items.place(x=1, y=230)
#Button New items : ajouter un produit dans la table (id,image,nom,prix,quantite)
news = tk.Button(r, text='Ajouter un produit', width=46, background="#683FA9", fg="white", highlightbackground="#683FA9", activebackground="#4E2A88", activeforeground="white", command=news_visibility)
