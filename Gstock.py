...
def blue():
 ...
 new_page_text = tk.Label(news, text="Ajout d'un Nouveau Produit", font=("Arial", 24), fg="#3C7092", background="#BBBBBB")
 new_page_text.place (x=350, y=20)
 doc_page_text = tk.Label(document, text="Contenu du page document", font=("Arial", 24), fg="#3C7092", background="#BBBBBB")
 doc_page_text.place (x=350, y=20)
 exp_page_text = tk.Label(exp, text="Vente du Nouveau Produit", font=("Arial", 24), fg="#3C7092", background="#BBBBBB")
 ...
 prix = tk.Label(news, text="Prix         :", font=("Arial", 18), fg="#3C7092", background="#BBBBBB")
 ...
 produitajouterbutton = tk.Button(news, text='Ajouter', width=30, background="#3C7092", fg="white", activebackground="#3D0E89", activeforeground="white")
 produitajouterbutton.place(x=200, y=500)
 #button annuler
 produitannulerbutton = tk.Button(news, text='Annuler', width=30, background="#3C7092", fg="white", activebackground="#3D0E89", activeforeground="white", command=reset)
 produitannulerbutton.place(x=600, y=500)
 produitajouterbutton = tk.Button(exp, text='Ajouter', width=30, background="#3C7092", fg="white", activebackground="#3D0E89", activeforeground="white")
 produitajouterbutton.place(x=200, y=500)
 #button annuler
 produitannulerbutton = tk.Button(exp, text='Annuler', width=30, background="#3C7092", fg="white", activebackground="#3D0E89", activeforeground="white", command=reset)
 produitannulerbutton.place(x=600, y=500)
