...
def green():
 ...
 dashbroadstatic2.place(x=400, y=350)
 dashbroadstatic3.place(x=700, y=350)
 dashbroad_text = tk.Label(dashbroad, text="Tableau du Bord", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 dashbroad_text.place (x=350, y=20)
 items_page_text = tk.Label(items, text="Contenu du page items ", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 items_page_text.place (x=350, y=20)
 new_page_text = tk.Label(news, text="Ajout d'un Nouveau Produit", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 new_page_text.place (x=350, y=20)
 doc_page_text = tk.Label(document, text="Contenu du page document", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 doc_page_text.place (x=350, y=20)
 exp_page_text = tk.Label(exp, text="Vente du Nouveau Produit", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 exp_page_text.place (x=350, y=20)
 setting_page_text = tk.Label(setting, text="Parametre", font=("Arial", 24), fg="#609928", background="#BBBBBB")
 setting_page_text.place (x=350, y=20)
 h = canvas.create_text(800, 40, text=heure_actuelle, fill="white", font='Helvetica 20 bold')
def red():
 canvas.create_rectangle(400, 800, 1500, 0, fill="white")
 ...
 logout.place(x=1380, y=10)
 dashbroad_text = tk.Label(dashbroad, text="Tableau du Bord", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 dashbroad_text.place (x=350, y=20)
 items_page_text = tk.Label(items, text="Contenu du page items ", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 items_page_text.place (x=350, y=20)
 new_page_text = tk.Label(news, text="Ajout d'un Nouveau Produit", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 new_page_text.place (x=350, y=20)
 doc_page_text = tk.Label(document, text="Contenu du page document", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 doc_page_text.place (x=350, y=20)
 exp_page_text = tk.Label(exp, text="Vente du Nouveau Produit", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 exp_page_text.place (x=350, y=20)
 setting_page_text = tk.Label(setting, text="Parametre", font=("Arial", 24), fg="#A94A6E", background="#BBBBBB")
 setting_page_text.place (x=350, y=20)
 h = canvas.create_text(800, 40, text=heure_actuelle, fill="white", font='Helvetica 20 bold')
#canvas
