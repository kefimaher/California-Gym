...
#tableau du bord
dashbroad = tk.Button(r, text='Tableau du Bord', width=46, background="#3E4146", fg="white", highlightbackground="#3E4146", activebackground="#DE9B1C", activeforeground="white", command=dashbroad_visibility)
...
s5= tk.Button(setting, text='', height=2, width=3, background="#DE9B1C", activebackground="#DE9B1C")
s1.place(x=0, y=150)
