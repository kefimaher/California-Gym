...
dashbroadstatic1 = tk.Button(dashbroad, text='1', height=8, width=30,  background="#76448A", state='disabled')
dashbroadstatic2 = tk.Button(dashbroad, text='2', height=8, width=30, background="#ADC9CB", state='disabled')
dashbroadstatic3 = tk.Button(dashbroad, text='3', height=8, width=30, background="#A5CACC", state='disabled')
