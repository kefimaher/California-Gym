...
def violette():
 ...
 search = tk.Button(r, text='Chercher', width=10, background="#683FA9", fg="white", command=on_submit, activebackground="#683FA9", activeforeground="white")
 search.place(x=1380, y=113)
 test1 = tk.Button(r, text='Test', width=10, background="#683FA9", fg="white", activebackground="#4F91BD", activeforeground="white")
 test1.place(x=420, y=113)
 test2 = tk.Button(r, text='Test', width=10, background="#683FA9", fg="white", activebackground="#4F91BD", activeforeground="white")
