...
dashbroadstatic1 = tk.Button(dashbroad, text='1', height=8, width=30,  background="#2980B9", state='disabled')
dashbroadstatic2 = tk.Button(dashbroad, text='2', height=8, width=30, background="#EB984E", state='disabled')
dashbroadstatic3 = tk.Button(dashbroad, text='3', height=8, width=30, background="#CD6155", state='disabled')
