...
dashbroadstatic3.place(x=700, y=300)
#xyz
a1= tk.Button(dashbroad, text='', height=8, width=1, background="#683FA9", state='disabled')
a2= tk.Button(dashbroad, text='', height=10, width=1, background="#683FA9", state='disabled')
a3= tk.Button(dashbroad, text='', height=3, width=1, background="#683FA9", state='disabled')
a4= tk.Button(dashbroad, text='', height=5, width=1, background="#683FA9", state='disabled')
a5= tk.Button(dashbroad, text='a5', height=9, width=1, background="#683FA9", state='disabled')
a6= tk.Button(dashbroad, text='a6', height=11, width=1, background="#683FA9", state='disabled')
a7= tk.Button(dashbroad, text='a7', height=3, width=1, background="#683FA9", state='disabled')
a8= tk.Button(dashbroad, text='a8', height=2, width=1,  background="#683FA9", state='disabled')
a1.place(x=200, y=120)
a2.place(x=300, y=90)
a3.place(x=400, y=208)
a4.place(x=500, y=176)
a5.place(x=600, y=110)
a6.place(x=700, y=60)
a7.place(x=800, y=90)
a8.place(x=900, y=90)
image = Image.open("1.jpg")
nouvelle_taille = (1500, 70)
