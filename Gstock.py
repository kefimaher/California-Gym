...
setting_page_text = tk.Label(setting, text="Change la couleur de l'application", font=("Arial", 18), fg="#683FA9", background="#BBBBBB")
setting_page_text.place (x=10, y=100)
violette= tk.Button(setting, text='', height=2, width=3, background="#683FA9", activebackground="#683FA9", command=violette)
green= tk.Button(setting, text='', height=2, width=3, background="#72B62E", activebackground="#72B62E", command=green)
violette.place(x=50, y=150)
green.place(x=150, y=150)
#date
